...
(function (app) {
  ...
  app.uiActionHandlers['auto-day-toggle-timer'] = function () {
    app.toggleAutoDayTimer();
  };
  ...
  app.uiActionHandlers['auto-day-go-vote'] = function () {
    app.startAutoVote();
  };
  app.uiActionHandlers['auto-day-skip-vote'] = function () {
    app.skipAutoVote();
  };
})(window.MafiaApp);
