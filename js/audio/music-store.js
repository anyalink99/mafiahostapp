...
(function (app) {
  // Общие внутренности музыки (см. music-volume.js) — newId/clampVol/normalizePlaylist
  // нужны music-zip.js при импорте/экспорте плейлистов.
  ...
  M.newId = newId;
  M.clampVol = clampVol;
  M.normalizePlaylist = normalizePlaylist;
